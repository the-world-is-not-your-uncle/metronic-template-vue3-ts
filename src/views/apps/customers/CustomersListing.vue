<template>
  <div class="card">
    ...
    <div class="card-body pt-0">
      ...
      >
        <template #cell-checkbox="{ row: customer }">
          <div
        ...
        <template #cell-name="{ row: customer }">
          {{ customer.name }}
        </template>
        ...
        <template #cell-company="{ row: customer }">
          {{ customer.company }}
        </template>
        <template #cell-paymentMethod="{ row: customer }">
          <img :src="customer.payment.icon" class="w-35px me-3" alt="" />{{
            customer.payment.ccnumber
          }}
        </template>
        <template #cell-date="{ row: customer }">
          {{ customer.date }}
        </template>
